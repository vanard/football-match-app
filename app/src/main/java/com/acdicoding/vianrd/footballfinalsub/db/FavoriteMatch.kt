...
@Parcelize
data class FavoriteMatch (val id: Long?, val idEvent: String, val homeTeam: String, val awayTeam: String, val homeScore: String?, val awayScore: String?, val dateEvent: String, val timeEvent: String): Parcelable {
